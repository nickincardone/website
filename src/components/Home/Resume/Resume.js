            ...
            <Grid item sm={6}>
                <Grid container>
                    <Grid item sm={12} className="nji-resume-about">
                        ...
                        <div><Typography variant="body1"><Email className="bottom-border"/><b>{resumeData.contact.email}</b></Typography></div>
                        <div><Typography variant="body1"><LinkedIn className="bottom-border"/><a href={resumeData.contact.linkedIn}>LinkedIn</a></Typography></div>
            ...
            <Grid item sm={6}>
                <Grid container>
                    <Grid item sm={12}>
                        ...
                        <Typography variant="subtitle2" component="h2">Graduated {resumeData.education.date}</Typography>
                        <Typography variant="body2">{resumeData.education.degree} <br/> {resumeData.education.concentration}</Typography>
                    </Grid>
                </Grid>
            </Grid>
