...
function Home() {
    ...
    return (
        <Container maxWidth="md" className="nji-main">
            ...
            <Typography className="nji-bottom-message" variant="subtitle2" component="div">Website created by me with React. <a href="https://github.com/nickincardone/website">See the code</a>.</Typography>
        </Container>
    );
};
